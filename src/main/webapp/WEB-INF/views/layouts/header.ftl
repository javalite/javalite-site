<div class="navbar navbar-fixed-top">
    <div class="navbar-inner">
        <div class="container">
            ...
            <a  href="/" class="brand">JavaLite <img src="/images/javalite_feather.png" width="40px" height="40px"/></a>
                    ...
                    <li>
                        <div id="twitter" style="margin-top: 13px;">
                            <a href="https://twitter.com/share" class="twitter-share-button"
                               data-url="http://javalt.org"
                               data-via="ipolevoy" data-lang="en">Tweet</a>
